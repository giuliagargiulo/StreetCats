...
class CatIn(BaseModel):
    ...
    location: Location = Field(..., title="Location where the cat was found", example={
                               "latitude": 40.7128, "longitude": -74.0060})
    picture_url: str = Field(..., title="URL of the cat picture",
...
async def create_cat(cat: CatIn, user_uu_id: UUID = Depends(get_current_user), pgdb: Database = Depends(get_db)):
